...
<head>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="panel panel-white">
                  <div class="panel-heading">
                     <h4 class="panel-title">Liste de vos Administrateurs</h4>
                                
                   </div>
                  <div class="panel-body">
                  <div class="table-responsive project-stats">
			        <a class="btn btn-success"  id="addUser" href="#">Ajouter un administrateur</a>
                ...
                <div class="col-lg-12 col-md-12">
                 <div class="panel panel-white">
                  <div class="panel-heading">
                     <h4 class="panel-title ">Liste de vos projets (CLIQUER POUR DEROULER) </h4>
                   </div>
				 </div>
				 
				 <div class="container text-right">
			    	 <a class="btn btn-info"  id="addTache" href="#">Ajouter une Projet</a>
			     </div>
			     ...
			     <hr>
             	 ...
             	 <button class="collapsible"><h3 class="panel-title">LISTE DE VOS PROJETS</button>
					<div class="content2">
						
  					     <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h5 class="panel-title"><span class="label label-primary" >Detail des Projet</span></h5>
                                </div>
                                <div class="panel-body">
                                    <div class="table-responsive project-stats">  
                                       ...
                                       <table class="table" id="tacheAffecterList">
                                           ...
                                           <tbody>
                                           <h5 class="panel-title">Projets deja affecter(<c:out value = "${listProjetAffecter.size()  }" />)</h5>
                                            <c:forEach var = "listTache" items = "${listProjetAffecter}">
                                               <tr>
                                                   <th scope="row"><c:out value = "${listTache.getCode_projet()  }" /></th>
                                                   <td><c:out value = "${listTache.getLib_proj()  }" /></td>
                                                   <td><c:out value = "${listTache.getBudget_proj()  }" /></td>
													...
													<td><c:out value = "${listTache.getType_projet()  }" /></td>
												    <c:choose>
                                                     ...
                                                     <td>
                                                     	...
                                                     	<c:choose>
							                              <c:when test="${listTache.getStatut() != 'Annuler' && listTache.getStatut() != 'Terminer'}">
							                               <a id ="editId" class="label editBtn" data-userId = "<c:out value = "${listTache.getCode_projet() }" />"
														   data-idTache = "<c:out value = "${listTache.getCode_projet()}"/>"
						                    				data-lib_tc = "<c:out value = "${listTache.getLib_proj() }"/>"
						                    				data-coutUnitaire = "<c:out value = "${listTache.getBudget_proj() }"/>"
														...
														<c:choose>
							                              <c:when test="${listTache.getStatut() == 'Non Debuter' || listTache.getStatut() == 'Suspendu' && listTache.getStatut() != 'Terminer' }">
							                               <a id ="editId" class="label" data-userId = "<c:out value = "${listTache.getCode_projet() }" />"
														   data-tacheAvancement = "<c:out value = "${ listTache.getAvancement() }" />" 
														   href="demarerProjet?code_tc=<c:out value = "${listTache.getCode_projet() }" />&adminId=<c:out value = "${user.getId() }" />"><span class="label label-primary">Demarer</span></a>
							                              ...
							                              <c:when test="${listTache.getStatut() != 'Annuler' && listTache.getStatut() != 'Terminer' }">
							                               <a id ="editId" class="label" data-userId = "<c:out value = "${listTache.getCode_projet() }" />"
														   data-tacheAvancement = "<c:out value = "${ listTache.getAvancement() }" />" 
														   href="retirerProjet?code_tc=<c:out value = "${listTache.getCode_projet() }" />&adminId=<c:out value = "${user.getId() }" />&ancienUserId=<c:out value = "${listTache.getResponsable().getId() }" />"><span class="label label-primary">Retirer</span></a>
														...
														<c:choose>
							                              <c:when test="${listTache.getStatut() != 'Suspendu' && listTache.getStatut() != 'Annuler' && listTache.getStatut() != 'Terminer'}">
							                                <a id ="editId" class="label" data-userId = "<c:out value = "${listTache.getCode_projet() }" />"
														   data-tacheAvancement = "<c:out value = "${listTache.getAvancement() }" />" 
														   href="suspendreProjet?code_tc=<c:out value = "${listTache.getCode_projet() }" />&adminId=<c:out value = "${user.getId() }" />"><span class="label label-warning">Suspendre</span></a>
														...
														<c:choose>
							                              <c:when test="${listTache.getStatut() != 'Annuler' && listTache.getStatut() != 'Terminer'}">
							                                <a id ="editId" class="label" data-userId = "<c:out value = "${listTache.getCode_projet() }" />"
														    data-tacheAvancement = "<c:out value = "${listTache.getAvancement() }" />" 
														    href="annulerProjet?code_tc=<c:out value = "${listTache.getCode_projet() }" />&adminId=<c:out value = "${user.getId() }" />"><span class="label label-danger">Annuler</span></a>
							                              </c:when>
                           							     </c:choose>
							                              ...
							                              <c:when test="${listTache.getStatut() != 'Terminer' && listTache.getStatut() != 'Annuler'}">
							                                <a id ="editId" class="label" data-userId = "<c:out value = "${listTache.getCode_projet() }" />"
														    data-tacheAvancement = "<c:out value = "${listTache.getAvancement() }" />" 
														    href="terminerProjet?code_tc=<c:out value = "${listTache.getCode_projet() }" />&adminId=<c:out value = "${user.getId() }" />"><span class="label label-success">Terminer</span></a>
							                              </c:when>
                           							     </c:choose>
													</td>
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive project-stats">  
                                       ...
                                       <table class="table" id="tacheNonAffecterList">
                                           ...
                                           <tbody>
                                            <h5 class="panel-title">Projets Non Encore affecter(<c:out value = "${listProjetNonAffecter.size()  }" />)</h5>
                                            <c:forEach var = "listTache" items = "${listProjetNonAffecter}">
                                               <tr>
                                                   <th scope="row"><c:out value = "${listTache.getCode_projet()  }" /></th>
                                                   <td><c:out value = "${listTache.getLib_proj()  }" /></td>
                                                   <td><c:out value = "${listTache.getBudget_proj()  }" /></td>
												...
												<td><c:out value = "${listTache.getType_projet()  }" /></td>
                                                   ...
                                                   <td><c:out value = "${listTache.getDate_fin()  }" /></td>
													...
													<td>
														<c:choose>
							                              <c:when test="${listTache.getStatut() != 'Annuler'}">
							                               <a id ="editId" class="label editTacheNonAffecter" data-userId = "<c:out value = "${listTache.getCode_projet() }" />"
														   data-idTache = "<c:out value = "${listTache.getCode_projet()}"/>"
						                    				data-lib_tc = "<c:out value = "${listTache.getLib_proj() }"/>"
						                    				data-coutUnitaire = "<c:out value = "${listTache.getBudget_proj() }"/>"
						                    				data-dateDebut = "<c:out value = "${listTache.getDate_debut() }"/>"
														...
														<c:choose>
							                              <c:when test="${listTache.getStatut() != 'Annuler'}">
							                               <a id ="affecterId" class="label affecterBtn" data-userId = "<c:out value = "${listTache.getCode_projet() }" />"
														   data-code_tc = "<c:out value = "${listTache.getCode_projet() }" />" 
  ...
  <div id="editModalTache" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      ...
      <form id="tacheForm" class="w3-container" action="updateProjet" method="post">
        <div class="w3-section">
				<input type="hidden" id="hiddenAdminId" name="idAdmin" value="<c:out value = "${user.getId() }" />" />
				<input type="hidden" id="hiddenId" name="id" value="" />
          ...
          <label class="affecter"><b>Budget</b></label>
		 ...
		 <div class="w3-container affecter w3-margin-top">
			<label><b>Type Projet</b></label>
			<select class="w3-select w3-border w3-round-large" name="typeProjet" id="typeProjet">
				<option value="Conception" selected>Conception</option>
...
$('#tacheNonAffecterList').on('click', '.affecterBtn', function() {
	...
	document.getElementById("tacheForm").action = "affecterProjet";
...
$('#tacheAffecterList').on('click', '.editBtn', function() {
	...
	$('#addTache').on('click', function() {
		...
		document.getElementById("tacheForm").action = "insertProjet";
